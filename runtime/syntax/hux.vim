...
syn keyword helpNote		note Note NOTE note: Note: NOTE: Notes Notes: megjegyzés Megjegyzés MEGJEGYZÉS megjegyzés: Megjegyzés Megjegyzés:
syn keyword helpWarning		WARNING WARNING: Warning: FIGYELEM FIGYELEM: Figyelem:
syn keyword helpDeprecated	DEPRECATED DEPRECATED: Deprecated: ELAVULT ELAVULT: Elvault:
...
syn match helpSpecial		"\[tartomány]"
syn match helpSpecial		"\[line]"
syn match helpSpecial		"\[sor]"
syn match helpSpecial		"\[count]"
syn match helpSpecial		"\[mennyiség]"
syn match helpSpecial		"\[offset]"
syn match helpSpecial		"\[offszet]"
...
syn match helpSpecial		"\[behúzás]"
syn match helpSpecial		"\[addr]"
syn match helpSpecial		"\[cím]"
syn match helpSpecial		"\[group]"
syn match helpSpecial		"\[csoport]"
